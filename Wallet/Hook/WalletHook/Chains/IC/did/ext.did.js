export const idlFactory = ({IDL}) => {
    ...
    return IDL.Service({
        ...
        'addAsset': IDL.Func([IDL.Text, IDL.Nat32, IDL.Vec(IDL.Nat8)], [], []),
        ...
        'mintAndList': IDL.Func(
            [AccountIdentifier__1, IDL.Opt(IDL.Vec(IDL.Nat8)), IDL.Nat64, IDL.Text],
            [TokenIndex],
            [],
        ),
        ...
        'salesStats': IDL.Func(
            ...
            [IDL.Bool, IDL.Nat, IDL.Nat, IDL.Nat64],
            ['query'],
        ),
